...
namespace BrainfuckSharpLibrary.AbstractSyntaxTree
{
    ...
    public class Loop : Statement, IEquatable<Loop>
    {
        ...
        /// <see cref="BrainfuckSharpLibrary.AbstractSyntaxTree.Loop"/> is 
        /// equal to this instance.
        /// </summary>
        /// <param name="loop">The 
        /// <see cref="BrainfuckSharpLibrary.AbstractSyntaxTree.Loop"/> to compare 
        /// with this instance.</param>
        /// <returns>
        ///   <c>true</c> if the specified
        ///   <see cref="BrainfuckSharpLibrary.AbstractSyntaxTree.Loop"/> is equal 
