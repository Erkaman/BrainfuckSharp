...
namespace BrainfuckSharp.AbstractSyntaxTree
{
    ...
    public class Command : Statement, IEquatable<Command>
    {
        ...
        /// <see cref="BrainfuckSharp.AbstractSyntaxTree.Command"/> 
        /// is equal to this instance.
        /// </summary>
        /// <param name="command">The 
        /// <see cref="BrainfuckSharp.AbstractSyntaxTree.Command"/> to compare with 
        /// this instance.</param>
        /// <returns>
        ///   <c>true</c> if the specified 
        ///   <see cref="BrainfuckSharp.AbstractSyntaxTree.Command"/> is 
        ///   equal to this instance; otherwise, <c>false</c>.
        /// </returns>
